    ...
    public class SerializeHelper
    {
        ...
        public bool Save(object obj, string filename)
        {
            ...
            try
            {
                ...
                setings.Encoding = Encoding.UTF8;
                setings.Indent = true;
        ...
        /// 文件化XML反序列化
        /// </summary>
        /// <param name="type">对象类型(调用时使用typeof())</param>
        /// <param name="filename">文件路径</param>
        ...
        /// <param name="obj">对象</param>
        /// <param name="filename">文件路径</param>
        public static bool Saves(object obj, string filename)
        {
            bool success = false;
            FileStream fs = null;
            try
        ...
        /// <param name="type">对象类型(调用时使用typeof())</param>
        /// <param name="filename">文件路径</param>
        public static object Loads(Type type, string filename)
        {
            FileStream fs = null;
            try
            {
