...
namespace YudianBlog.Infrastructure.Config
{
    ...
    {
       static Common.SerializeHelper serialize = new SerializeHelper();
        ...
        {
            return (IConfigInfo)serialize.Load(configtype, configfilepath);
        }
        ...
        {
            return serialize.Save(configinfo, configFilePath);
        }
    }
}
